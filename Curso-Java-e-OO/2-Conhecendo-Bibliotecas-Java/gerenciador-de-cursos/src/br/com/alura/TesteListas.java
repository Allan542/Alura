...
public class TesteListas {
    ...
    public static void main(String[] args) {
        ...
        tempoArrayList = percorrerLista(numerosArrayList, quantidadeElementos);
        tempoLinkedList = percorrerLista(numerosLinkedList, quantidadeElementos);
        
        System.out.println("Percorrer elementos da ArrayList demorou  " + tempoArrayList);
        System.out.println("Percorrer elementos da LinkedList demorou " + tempoLinkedList);
    }
    ...
    private static long percorrerLista(List<Integer> numeros, int quantidade) {
        long ini = System.currentTimeMillis();
        numeros.get(quantidade/2);
        numeros.set(quantidade/2, quantidade/2);
        long fim = System.currentTimeMillis();
        return fim-ini;
    }
