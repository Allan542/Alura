	...
	public ProdutoCategoriaFrame() {
		...
		tabela.addMouseListener(new MouseListener() {
			...
			public void mouseClicked(MouseEvent e) {
				...
				if(tabela.getSelectedRow() != -1 && objetoDaLinha instanceof Integer) {
					System.out.println(Integer.valueOf((Integer) objetoDaLinha));
					textoNome.setText((String) modelo.getValueAt(tabela.getSelectedRow(), 1));
					textoDescricao.setText((String) modelo.getValueAt(tabela.getSelectedRow(), 2));
				}
			}
		});
	}
