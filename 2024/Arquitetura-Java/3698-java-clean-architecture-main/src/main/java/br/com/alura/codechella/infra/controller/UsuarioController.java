...
public class UsuarioController {
    ...
    @PutMapping("/{cpf}")
    public UsuarioDto alterarUsuario(@PathVariable String cpf, @RequestBody UsuarioDto dto){
        Usuario alterado = alterarUsuario.alterarUsuario(cpf, new Usuario(dto.cpf(), dto.nome(), dto.nascimento(), dto.email()));
        if (alterado == null) return null;
        return new UsuarioDto(alterado.getCpf(), alterado.getNome(), alterado.getNascimento(), alterado.getEmail());
    }
